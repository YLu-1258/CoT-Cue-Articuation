...
export TENSORBOARD_DIR=mnt/tensorboard_log/grpo_gemma2_2b_b64/fsdp2_rebase_ckpt
MODEL_PATH=huggingface.co/Qwen/Qwen2-7B-Instruct
DATA_PATH=./
...
nohup python3 -m verl.trainer.main_ppo \
    ...
    trainer.test_freq=5 \
    trainer.total_epochs=15 $@ > fsdp2_re.log 2>&1 &